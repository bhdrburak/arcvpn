...
public abstract class Hilt_ManualSetupFragment extends BaseLoginFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManualSetupFragment_GeneratedInjector) this.generatedComponent()).injectManualSetupFragment(UnsafeCasts.<ManualSetupFragment>unsafeCast(this));
    }
  }
