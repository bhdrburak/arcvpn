...
public final class AuthRepositoryImpl_Factory implements Factory<AuthRepositoryImpl> {
  ...
  public AuthRepositoryImpl_Factory(Provider<VpnAPI> apiServiceProvider,
  ...
  public static AuthRepositoryImpl_Factory create(Provider<VpnAPI> apiServiceProvider,
      Provider<NetworkChecker> networkCheckerProvider,
      Provider<ErrorHandler> errorHandlerProvider) {
    return new AuthRepositoryImpl_Factory(apiServiceProvider, networkCheckerProvider, errorHandlerProvider);
  }

  public static AuthRepositoryImpl newInstance(VpnAPI apiService, NetworkChecker networkChecker,
      ErrorHandler errorHandler) {
    return new AuthRepositoryImpl(apiService, networkChecker, errorHandler);
  }
}
