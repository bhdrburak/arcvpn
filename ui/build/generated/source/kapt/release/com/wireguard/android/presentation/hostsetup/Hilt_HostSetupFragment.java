...
public abstract class Hilt_HostSetupFragment extends BaseLoginFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HostSetupFragment_GeneratedInjector) this.generatedComponent()).injectHostSetupFragment(UnsafeCasts.<HostSetupFragment>unsafeCast(this));
    }
  }
