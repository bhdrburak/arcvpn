...
public abstract class Hilt_ConfigurationProfilesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfigurationProfilesFragment_GeneratedInjector) this.generatedComponent()).injectConfigurationProfilesFragment(UnsafeCasts.<ConfigurationProfilesFragment>unsafeCast(this));
    }
  }
